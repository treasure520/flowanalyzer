...
# Special ASA fields per http://www.cisco.com/c/en/us/td/docs/security/asa/special/netflow/guide/asa_netflow/guide/asa_netflow.html#pgfId-1330387
v9_fields = {
    ...
    32: {
        # Use to calculat ICMP Type and Code (ICMP type*256 + ICMP Code), http://www.nthelp.com/icmp.html
        'Name': 'ICMP_TYPE',
        'Type': 'Integer',
        'Index ID': 'ICMP Type',
        'Options': {
    ...
    44: {'Name': 'IPV4_SRC_PREFIX', 'Type': 'Integer', 'Index ID': 'IPv4 Source Address Prefix'},
    45: {'Name': 'IPV4_DST_PREFIX', 'Type': 'Integer', 'Index ID': 'IPv4 Destination Address Prefix'},
    46: {
    ...
    63: {'Name': 'BGP_IPV6_NEXT_HOP', 'Type': 'IPv6', 'Index ID': 'BGP IPv6 Next Hop'},
    ...
    139: {'Name': 'icmpTypeCodeIPv6', 'Type': 'Integer', 'Index ID': 'IPv6 ICMP Type'},
    ...
    210: {'Name': 'paddingOctets', 'Type': 'Integer', 'Index ID': 'Padding Bytes'},
    ...
    281: {'Name': 'postNATSourceIPv6Address', 'Type': 'IPv6', 'Index ID': 'Post-NAT IPv6 Source'},
    ...
    285: {'Name': 'anonymizationFlags', 'Type': 'Integer', 'Index ID': 'Anonymization Flags'},
    286: {
    ...
    333: {'Name': 'hashDigestOutput', 'Type': 'Boolean', 'Index ID': 'Hash Digest Output'},
    ...
    344: {'Name': 'informationElementSemantics', 'Type': 'Integer', 'Index ID': 'Information Element Semantics'},
    ...
    373: {'Name': 'applicationSubCategoryName', 'Type': 'String', 'Index ID': 'Application Sub Category Name'},
    ...
    # Deprecated per standard
    416: {'Name': 'deprecated', 'Type': 'Deprecated', 'Index ID': 'Deprecated'},
    ...
    # Deprecated per standard
    419: {'Name': 'deprecated', 'Type': 'Deprecated', 'Index ID': 'Deprecated'},
    ...
    434: {'Name': 'mibObjectValueInteger', 'Type': 'Integer', 'Index ID': 'MIB Object Value Integer'},
    435: {'Name': 'mibObjectValueOctetString', 'Type': 'String', 'Index ID': 'MIB Object Value Octet String'},
    ...
    # Options Template for an SNMP MIB
    443: {'Name': 'mibObjectValueTable', 'Type': '', 'Index ID': 'MIB Object Value Table'},
    444: {'Name': 'mibObjectValueRow', 'Type': '', 'Index ID': 'MIB Object Value Row'},
    ...
    ## ASA (Proprietary)
    # 33000: {'Name': 'INGRESS_ACL_ID', 'Type': '', 'Index ID': 'Ingress ACL ID'},
    ## ASA (Proprietary)
    # 33001: {'Name': 'EGRESS_ACL_ID', 'Type': '', 'Index ID': 'Egress ACL ID'},
    ## ASA (Proprietary)
    # 33002: {'Name': 'NF_F_FW_EXT_EVENT', 'Type': 'Integer', 'Index ID': 'Firewall External Event'},
    ## ASA (Proprietary)
    # 40000: {'Name': 'AAA_USERNAME', 'Type': '', 'Index ID': 'AAA Username'}
}
...
ipfix_fields = {
    ...
    # Parsed in code, need to verify
    6: {'Name': 'tcpControlBits', 'Type': 'Integer', 'Index ID': 'TCP Flags'},
    ...
    19: {'Name': 'postMCastPacketDeltaCount', 'Type': 'Integer', 'Index ID': 'Post-Multicast Destination Packets'},
    20: {'Name': 'postMCastOctetDeltaCount', 'Type': 'Integer', 'Index ID': 'Post-Multicast Destination Bytes'},
    ...
    # Use to calculate ICMP Type and Code (Type*256 + Code)
    32: {'Name': 'icmpTypeCodeIPv4', 'Type': 'Integer', 'Index ID': 'IPv4 ICMP Type'},
    33: {'Name': 'igmpType', 'Type': 'Integer', 'Index ID': 'IGMP Type'},
    ...
    42: {'Name': 'exportedFlowRecordTotalCount', 'Type': 'Integer', 'Index ID': 'Total Flows Exported'},
    # Cisco proprietary for Cat 5000/6000
    43: {'Name': 'ipv4RouterSc', 'Type': 'IPv4', 'Index ID': 'Catalyst 5/6k Router Source'},
    ...
    # Parse in code
    64: {'Name': 'ipv6ExtensionHeaders', 'Type': 'Integer', 'Index ID': 'IPv6 Option Headers'},
    # 65: {'Name':'Vendor Proprietary', 'Type':'Vendor Proprietary', 'Index ID':'Vendor Proprietary'},
    # 66:{'Name':'Vendor Proprietary', 'Type':'Vendor Proprietary', 'Index ID':'Vendor Proprietary'},
    # 67: {'Name': 'Vendor Proprietary', 'Type': 'Vendor Proprietary', 'Index ID': 'Vendor Proprietary'},
    # 68: {'Name': 'Vendor Proprietary', 'Type': 'Vendor Proprietary', 'Index ID': 'Vendor Proprietary'},
    ...
    # REVIEW THIS FIELD FOR PARSING
    89: {'Name': 'forwardingStatus', 'Type': '', 'Index ID': 'Forwarding Status'},
    # REVIEW THIS FIELD FOR PARSING
    90: {'Name': 'mplsVpnRouteDistinguisher', 'Type': '', 'Index ID': 'VPN Route Distinguisher'},
    ...
    # REVIEW THIS!!!
    104: {'Name': 'layer2packetSectionData', 'Type': '', 'Index ID': 'Traffic Class Name'},
    # Assigned for Netflow v9 compatibility
    105: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    106: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    107: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    108: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    109: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    110: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    111: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    112: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    113: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    114: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    115: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    116: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    117: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    118: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    119: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    120: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    121: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    122: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    123: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    124: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    125: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    126: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    # Assigned for Netflow v9 compatibility
    127: {'Name': 'Compatibility', 'Type': 'Compatibility', 'Index ID': 'Compatibility'},
    128: {'Name': 'bgpNextAdjacentAsNumber', 'Type': 'Integer', 'Index ID': 'BGP Next Adjacent AS'},
    129: {'Name': 'bgpPrevAdjacentAsNumber', 'Type': 'Integer', 'Index ID': 'BGP Previous Adjacent AS'},
    130: {'Name': 'exporterIPv4Address', 'Type': 'IPv4', 'Index ID': 'Exporter IPv4 Address'},
    131: {'Name': 'exporterIPv6Address', 'Type': 'IPv6', 'Index ID': 'Exporter IPv6 Address'},
    ...
    415: {'Name': 'dot1qCustomerDestinationMacAddress', 'Type': 'MAC', 'Index ID': 'Dot1q Customer Destination MAC Address'},
    # Deprecated per standard
    416: {'Name': '', 'Type': 'Integer', 'Index ID': ''},
    417: {'Name': 'postLayer2OctetDeltaCount', 'Type': 'Integer', 'Index ID': 'Post-Layer 2 Byte Count'},
    418: {'Name': 'postMCastLayer2OctetDeltaCount', 'Type': 'Integer', 'Index ID': 'Post-Multicast Layer 2 Bytes'},
    # Deprecated per standard
    419: {'Name': '', 'Type': 'Integer', 'Index ID': ''},
    420: {'Name': 'postLayer2OctetTotalCount', 'Type': 'Integer', 'Index ID': 'Post-Layer 2 Total Bytes'},
    421: {'Name': 'postMCastLayer2OctetTotalCount', 'Type': 'Integer', 'Index ID': 'Post-Multicast Layer 2 Total Bytes'},
    422: {'Name': 'minimumLayer2TotalLength', 'Type': 'Integer', 'Index ID': 'Minimum Layer 2 Total Length'},
    423: {'Name': 'maximumLayer2TotalLength', 'Type': 'Integer', 'Index ID': 'Maximum Layer 2 Total Length'},
